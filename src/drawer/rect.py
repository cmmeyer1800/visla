...
class Rect:
    def __init__(
        self, center: tuple, height: int, width: int, color: tuple, parent: pygame.Surface, border_width: int
    ) -> None:
        """
    ...
    def draw(self) -> None:
        ...
        pygame.draw.rect(
            self.parent, self.color, pygame.Rect(left, top, self.width, self.height), self.border_width
        )
